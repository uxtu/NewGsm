...
public class Expenses {
    ...
    public ArrayList<Double> sumMileage(ArrayList<Cars> d, ArrayList<CarsWithParametrs> c) {
        double sum100 = 0.0;
        double sum200 = 0.0;
        double sum300 = 0.0;
        double sum400 = 0.0;
    ...
    public double allExpenses(ArrayList<Double> a) {
        double sum = 0.0;
        ...
        System.out.println("All expenses = " + sum * tariff);
        return sum;
    }
